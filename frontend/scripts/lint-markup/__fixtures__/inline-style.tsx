 ...
 * Elements 3 and 4 are two proved escapes: React writes camelCase, and every rule here was written
 * against the CSS property name with a word boundary in front of it, which does not match inside a
 * camelCase word. Both elements passed all seven checks, and element 3 rendered a real blur on the
 * real sidebar.
