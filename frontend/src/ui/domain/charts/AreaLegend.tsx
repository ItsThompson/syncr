 ...
 * The name is a required member of an entry, so a nameless chip fails the typecheck.
 *
 ...
 * Area carriers in one row; the kit follows the inventory in section 14 instead, which says chip plus name plus
 * figure.
 *
