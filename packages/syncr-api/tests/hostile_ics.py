"""``hostile_ics``: four feed bodies drawn from what real publishers actually emit.

Every row of section 06's ICS ingest table appears somewhere in this corpus, and each body
...
# keys, one component naming a zone no table maps, one cancelled occurrence, and a duplicate
