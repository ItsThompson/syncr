...
be asserted against an occupied log at all. Production wires ``NoRecordedOutcomes``, because
nothing writes a binding yet.
...
async def test_the_production_reader_answers_with_an_empty_log(fixture: Fixture) -> None:
    """`NoRecordedOutcomes` is the honest reading of the schema, not a stub in the suite."""
