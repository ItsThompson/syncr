...
A_TASK_THE_WEEK_HAS_REACHED = UUID("00000000-0000-4000-8000-0000000000d1")
A_TASK_THE_WEEK_HAS_NOT_REACHED = UUID("00000000-0000-4000-8000-0000000000d2")
...
STARTED_AND_PINNED = BindingRef.for_task(A_TASK_THE_WEEK_HAS_REACHED)
PINNED_ELSEWHERE = BindingRef.for_task(A_TASK_THE_WEEK_HAS_NOT_REACHED)
