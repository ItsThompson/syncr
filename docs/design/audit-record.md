...
| Bypassing the eight stops the shell repeats on every screen | **Nothing.** No skip link exists, and this audit did not add one: ticket 1563, with the per-screen figures and the three design decisions a fix owes |
